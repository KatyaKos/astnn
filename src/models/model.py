...
class Model(ABC):
    ...
    def __init__(self,
        ...
        self.__code_encoders: OrderedDict[str, Any] = OrderedDict()
    ...
    def load_metadata(self, data_dirs: List[RichPath], max_files_per_dir: Optional[int] = None, parallelize: bool = True
                      ) -> None:
    ...
    def load_data_from_files(self, data_files: Iterable[RichPath], is_test: bool,
                             return_num_original_samples: bool = False, parallelize: bool = True
    ...
    def __minibatch_to_feed_dict(self,
        ...
        for (language, language_encoder) in self.__code_encoders.items():
            language_encoder.minibatch_to_feed_dict(
                batch_data['per_language_code_data'][language], final_minibatch, is_train
            )
        ...
        if len(full_query_batch_data['query_sample_ids']) > 0:
    ...
    def __split_data_into_minibatches(self,
        ...
        while len(language_to_num_remaining_samples) > 0:
            ...
            picked_example_idx = language_to_num_remaining_samples[picked_language] - 1
